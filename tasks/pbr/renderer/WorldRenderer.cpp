...
void WorldRenderer::loadShaders()
{
  ...
  etna::create_program(
    "terrain_render",
    {PBR_RENDERER_SHADERS_ROOT "chunk.vert.spv",
     PBR_RENDERER_SHADERS_ROOT "subdivide_chunk.tesc.spv",
     PBR_RENDERER_SHADERS_ROOT "process_chunk.tese.spv",
     PBR_RENDERER_SHADERS_ROOT "terrain.frag.spv"});

  etna::create_program(
    "lights_displacement", {PBR_RENDERER_SHADERS_ROOT "displace_lights.comp.spv"});

  etna::create_program(
    "cubemap_render",
    {PBR_RENDERER_SHADERS_ROOT "skybox.vert.spv", PBR_RENDERER_SHADERS_ROOT "skybox.frag.spv"});
  etna::create_program(
    "deferred_shading",
